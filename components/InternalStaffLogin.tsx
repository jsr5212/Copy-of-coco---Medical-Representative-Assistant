...
interface InternalStaffLoginProps {
...
const InternalStaffLogin: React.FC<InternalStaffLoginProps> = ({ onLogin, onCancel }) => {
      ...
      <div className="max-w-md w-full relative">
        <div className="bg-slate-900 border border-slate-800 rounded-[3rem] p-12 shadow-[0_0_150px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-black text-white tracking-widest uppercase mb-1">Staff Terminal</h2>
          ...
          {step === 'CREDENTIALS' && (
            <form onSubmit={handleCredentialsSubmit} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="space-y-2">
                <label className="text-[8px] font-black text-slate-600 uppercase tracking-widest ml-1">Personnel Email</label>
                <input 
                  required 
                  type="email" 
                  ...
                  placeholder="name@pharmaintel.staff"
                  value={email} 
          ...
          {step === 'MFA' && (
            <form onSubmit={handleMfaSubmit} className="space-y-8 animate-in fade-in slide-in-from-right-10 duration-500">
              <div className="text-center">
                <p className="text-xs text-slate-400 mb-6">Enter the dynamic token from your hardware key.</p>
          ...
          <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col items-center gap-4">
             ...
             <div className="flex items-center gap-2">
                ...
                <span className="text-[7px] font-black text-slate-700 uppercase tracking-widest">Encrypted Tunnel Active</span>
             </div>
          </div>
        </div>
      </div>
...
export default InternalStaffLogin;
